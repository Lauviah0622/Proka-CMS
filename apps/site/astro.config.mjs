...
export default defineConfig({
  ...
  markdown: {
    ...
    remarkPlugins: [remarkCalcReadingMin, 'remark-gfm', ['remark-directive', {}], ['remark-directive-rehype', {}], 'remark-smartypants', ['remark-prism', {
    ...
    }], [`${root}/src/plugins/imageTrans.mjs`, {}], [`${root}/src/plugins/tableWrapper.mjs`, {}]]
  }
});